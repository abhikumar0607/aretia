...
use App\Http\Controllers\Shared\StaffReportController;
use App\Http\Controllers\Shared\CaseCommentController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:'.UserRole::SuperAdmin->value)->prefix('superadmin')->name('superadmin.')->group(function () {
        ...
        Route::get('/roles', [SuperAdminRolePermissionController::class, 'index'])->name('roles.index');
        Route::post('/roles', [SuperAdminRolePermissionController::class, 'update'])->name('roles.update');
    });
    ...
    Route::middleware('role:'.UserRole::Admin->value)->prefix('admin')->name('admin.')->group(function () {
        Route::middleware('permission:onboarding.approve')->group(function () {
        ...
        Route::middleware('permission.any:orders.create,orders.approve')->group(function () {
        ...
        Route::middleware('permission.any:reports.view,reports.manage')->group(function () {
            Route::get('/reports', [StaffReportController::class, 'index'])->name('reports.index');
            Route::get('/reports/{report}', [StaffReportController::class, 'show'])->name('reports.show');
            Route::get('/reports/{report}/download', [ReportDownloadController::class, 'staff'])->name('reports.download');
        });
        ...
        Route::middleware('permission.any:clients.view,clients.manage')->group(function () {
        ...
        Route::middleware('permission.any:employees.view,employees.manage')->group(function () {
    ...
    Route::middleware(['role:'.UserRole::Client->value, 'client.onboarded'])->prefix('client')->name('client.')->group(function () {
        ...
        Route::middleware('company.active')->group(function () {
            ...
            Route::middleware('permission.any:reports.view,reports.manage')->group(function () {
                ...
                Route::match(['get', 'post'], '/reports/{report}/download', [ReportDownloadController::class, 'client'])->name('reports.download');
            });
        });
    });
    ...
    foreach (UserRole::employeeRoles() as $employeeRole) {
        Route::middleware('role:'.$employeeRole->value)
            ...
            ->group(function () use ($employeeRole) {
