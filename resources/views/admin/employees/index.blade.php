                ...
                <tr>
                    ...
                    <td class="cell-action">
                        @include('partials.user-account-actions', [
                            'user' => $employee,
                            'canManage' => $canManage,
                            'editRoute' => route('admin.employees.edit', $employee),
                            'deactivateRoute' => route('admin.users.deactivate', $employee),
                            'activateRoute' => route('admin.users.activate', $employee),
                            'deleteRoute' => route('admin.users.destroy', $employee),
                        ])
                    </td>
                </tr>
            @empty
                    ...
                    <td colspan="6">
                        <div class="empty-state">
                            @if($hasFilters)
                                ...
                                <a href="{{ route('admin.employees.index') }}" class="btn btn-secondary btn-sm">Clear filters</a>
                            @else
