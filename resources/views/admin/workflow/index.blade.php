...
<div class="card">
    <form method="POST" action="{{ route('admin.workflow.store') }}" class="workflow-stage-form">
        @csrf
    ...
    <table>
        ...
        @foreach($stages as $stage)
            <tr>
                ...
                <td>{{ $stage->slug }}</td>
                <td>
                    <form method="POST" action="{{ route('admin.workflow.responsible', $stage) }}">
                        @csrf
                        @method('PATCH')
                ...
                <td>
                    <div style="display:flex;gap:0.5rem;justify-content:flex-end;flex-wrap:wrap;">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.workflow.delete', $stage) }}">
                            @csrf
                            @method('DELETE')
