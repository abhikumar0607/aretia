...
<aside class="sidebar sidebar--admin">
    ...
    <nav class="sidebar-nav" aria-label="Main navigation">
        ...
        @endperm
        @if(auth()->user()->hasPermission('orders.create') || auth()->user()->hasPermission('orders.approve'))
        ...
        @endperm
        @if(auth()->user()->hasPermission('reports.view') || auth()->user()->hasPermission('reports.manage'))
        <a href="{{ route('admin.reports.index') }}" class="{{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">{!! $icon('M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') !!} Reports</a>
        @endif
        ...
        @if(auth()->user()->hasPermission('clients.view') || auth()->user()->hasPermission('clients.manage'))
        ...
        @endif
        @if(auth()->user()->hasPermission('employees.view') || auth()->user()->hasPermission('employees.manage'))
