@if(!empty($charts))
@php
    $casesIndexRoute = auth()->check() ? \App\Support\PortalRoute::routeIfExists('cases.index') : null;
    $ordersIndexRoute = auth()->check() ? \App\Support\PortalRoute::routeIfExists('orders.index') : null;
    $chartIcons = [
