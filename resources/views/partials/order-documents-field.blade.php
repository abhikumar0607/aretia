<div class="form-field order-documents-field">
    ...
    <p class="form-field-hint">PDF, Word, or images — max {{ \App\Services\PublicUploadService::MAX_MB }} MB each. You can add multiple files.</p>
    <div class="import-file-zone order-file-zone" data-dropzone>
        <input type="file" id="order_documents" multiple accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.zip">
