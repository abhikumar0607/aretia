...
<div class="card review-actions-card" style="margin-bottom:1.25rem;">
    ...
    <div class="review-actions">
        <div class="approve-form">
            <form method="POST" action="{{ route('superadmin.orders.approve', $order) }}" id="order-approve-form">
                @csrf
            </form>
        ...
        <form method="POST" action="{{ route('superadmin.orders.reject', $order) }}" class="reject-form">
            @csrf
