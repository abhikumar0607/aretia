...
<div class="case-actions-grid">
    ...
    @if(auth()->user()->role === \App\Enums\UserRole::Fqa)
        <section class="case-action-card card case-action-card-accent">
            ...
            <form method="POST" action="{{ \App\Support\PortalRoute::route('reports.store', $case) }}" id="report-upload-form" class="case-action-form">
                @csrf
                <div class="form-field">
                ...
                <div class="form-field">
                    ...
                    <p class="form-field-hint">Max {{ \App\Services\PublicUploadService::MAX_MB }} MB</p>
