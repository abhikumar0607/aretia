...
<div class="order-form-panel card">
    <form method="POST" action="{{ route('client.orders.store') }}" class="order-form" id="order-form">
        @csrf
        ...
        <div class="order-form-section">
            ...
            <div class="form-field">
                ...
                @include('partials.package-picker-hint')
            </div>
        </div>
        ...
        <div class="order-form-section">
            ...
            <div class="form-field">
                ...
                <input type="date" class="due-date-future-only" name="due_date" id="due_date" value="{{ \App\Support\DueDateRules::formValue(old('due_date')) }}" min="{{ \App\Support\DueDateRules::minDate() }}">
        ...
        <div class="order-form-footer">
            <p class="form-hint">By placing this order, you agree the information provided is accurate. Our team will review it before work begins.</p>
